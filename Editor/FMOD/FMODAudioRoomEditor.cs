...
namespace Point.Audio.FMODEditor
{
    ...
    public sealed class FMODAudioRoomEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Slider(reflectivity, 0.0f, FMODManager.ResonanceAudioHelper.maxReflectivity, reflectivityLabel);

            EditorGUILayout.Separator();

            EditorGUILayout.LabelField(reverbPropertiesLabel);
            ++EditorGUI.indentLevel;
            EditorGUILayout.Slider(reverbGainDb, FMODManager.ResonanceAudioHelper.minGainDb, FMODManager.ResonanceAudioHelper.maxGainDb,
                                   reverbGainLabel);
            EditorGUILayout.Slider(reverbBrightness, FMODManager.ResonanceAudioHelper.minReverbBrightness,
                                   FMODManager.ResonanceAudioHelper.maxReverbBrightness, reverbBrightnessLabel);
            EditorGUILayout.Slider(reverbTime, 0.0f, FMODManager.ResonanceAudioHelper.maxReverbTime, reverbTimeLabel);
            --EditorGUI.indentLevel;
